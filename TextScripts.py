...
MyFeaturesMessages = ["Je peux vous aider en cherchant des formations, en vous donnant des informations les concernant ou en vous redirigeant vers les contacts permettant de vous inscrire. Si je n'ai pas su répondre à votre question c'est parce qu'elle ne figure surement pas dans notre base de donnée. N'oubliez pas que je ne réponds qu'aux questions concernant l'industrie 4.0"]
